...
namespace CapaPresentacionAdmin.Controllers
{
    ...
    public class MantenedorController : Controller
    {
        ...
        public MantenedorController()
        {
            ...
            httpClient.BaseAddress = new Uri("https://localhost:44331/api");
        ...
        //    HttpResponseMessage response = await httpClient.GetAsync("https://localhost:44331/api/Productoes");
        //    if (response.IsSuccessStatusCode)
        //    {
        //        string contenido = await response.Content.ReadAsStringAsync();
        //        oProd = JsonConvert.DeserializeObject<List<Producto>>(contenido);
        //    }
        //    else
        //    {
        ...
        //[HttpPost]
        //public async Task<JsonResult> RegistrarProducto(string obj, HttpPostedFileBase fileImg)
        //{
        //    string mensaje = string.Empty;
        //    bool operacion_exitosa = true;
        //    bool save_image_success = true;

        //    Producto oProduct = JsonConvert.DeserializeObject<Producto>(obj);
        ...
        //    if (oProduct.IdProducto == 0)
        //    {
        //        string jsonContent = JsonConvert.SerializeObject(oProduct);
        //        StringContent httpContent = new StringContent(jsonContent, Encoding.UTF8, "application/json");

        //        HttpResponseMessage response = await httpClient.PostAsync("mi-endpoint/RegistrarProducto", httpContent);
        //        if (response.IsSuccessStatusCode)
        //        {
        //            string contenido = await response.Content.ReadAsStringAsync();
        //            int idProductoGen = JsonConvert.DeserializeObject<int>(contenido);
        //            if (idProductoGen != 0)
        //            {
        //                oProduct.IdProducto = idProductoGen;
        //            }
        ...
        //        HttpResponseMessage response = await httpClient.PostAsync("mi-endpoint/EditarProducto", httpContent);
        //        if (response.IsSuccessStatusCode)
        //        {
        //            string contenido = await response.Content.ReadAsStringAsync();
        //            operacion_exitosa = JsonConvert.DeserializeObject<bool>(contenido);
        //        }
        //        else
        //        {
        //            // Manejar el caso de error en la respuesta
        ...
        //                HttpResponseMessage response = await httpClient.PostAsync("mi-endpoint/SaveDataImg", httpContent);
        //                if (!response.IsSuccessStatusCode)
        //                {
        //                    mensaje = "Producto registrado, pero hubo problemas al guardar la imagen";
        //                }
        //            }
        //            else
        //            {
        ...
        //[HttpPost]
        //public async Task<JsonResult> ImgProduct(int id)
        //{
        //    bool conversion;
        //    Producto oProd = null;

        //    HttpResponseMessage response = await httpClient.GetAsync($"mi-endpoint/ObtenerProducto/{id}");
        //    if (response.IsSuccessStatusCode)
        //    {
        //        string contenido = await response.Content.ReadAsStringAsync();
        //        oProd = JsonConvert.DeserializeObject<Producto>(contenido);
        //    }
        //    else
        //    {
        //        // Manejar el caso de error en la respuesta
        ...
        //    if (oProd != null)
        //    {
        //        textBase64 = CN_Recursos.ConvertBase64(Path.Combine(oProd.RutaImagen, oProd.NombreImagen), out conversion);
        //    }
        ...
        //    HttpResponseMessage response = await httpClient.PostAsync($"mi-endpoint/EliminarProducto/{id}", null);
        //    if (response.IsSuccessStatusCode)
        //    {
        //        string contenido = await response.Content.ReadAsStringAsync();
        //        rpta = JsonConvert.DeserializeObject<bool>(contenido);
        //    }
        //    else
        //    {
        //        // Manejar el caso de error en la respuesta
