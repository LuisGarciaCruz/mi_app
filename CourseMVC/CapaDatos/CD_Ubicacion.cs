                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        ...
                        while (dr.Read())
                        {
                            ...
                            lista.Add(
                                new Departamento()
                                {
                                    IdDepartamento = dr["IdDepartement"].ToString(),
        ...
        public List<Provincia> ObtenerProvincia(string iddepartamento)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    string query = "select * from provincia where IdDepartment = @iddepartamento";
        ...
        public List<Distrito> ObtenerDistrito(string iddepartamento, string idprovincia)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    string query = "select * from district where IdProvincia = @idprovincia and IdDepartment = @iddepartamento";
